...
export const TaskItem: React.FC<TaskItemProps> = ({
  ...
  return (
    <div className="p-4 rounded-2xl bg-white/60 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80 shadow-sm flex flex-col gap-2.5 transition-all hover:border-violet-500/40">
      {/* Top Header */}
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          {isHistory ? (
            ...
            <>
              <span className="text-xs font-mono text-violet-600 dark:text-violet-400 font-semibold flex items-center gap-1">
