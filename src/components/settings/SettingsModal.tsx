      ...
      <div className="relative w-full max-w-lg glass-panel bg-white/95 dark:bg-slate-900/95 rounded-3xl overflow-hidden shadow-2xl border border-slate-200/80 dark:border-slate-800/80 flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200/60 dark:border-slate-800/60">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="关闭偏好设置"
            className="w-8 h-8 rounded-full flex items-center justify-center text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:outline-none transition-colors"
          >
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-xs">
          ...
          <div className="space-y-2">
            ...
            >
              <Folder className="w-4 h-4 text-violet-500" aria-hidden="true" />
              默认下载保存路径
            </label>
            <div className="flex items-center gap-2">
              <input
              ...
              <button
                ...
                className="px-3 py-2 rounded-xl bg-violet-600 hover:bg-violet-500 text-white font-medium flex items-center gap-1 shrink-0 focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 focus-visible:outline-none transition-colors"
              >
          ...
          <div className="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800/80">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                { id: "light", name: "浅色明亮", icon: <Sun className="w-4 h-4" aria-hidden="true" /> },
                { id: "dark", name: "深色极夜", icon: <Moon className="w-4 h-4" aria-hidden="true" /> },
                { id: "system", name: "跟随系统", icon: <Monitor className="w-4 h-4" aria-hidden="true" /> },
              ].map((item) => (
                <button
                  key={item.id}
                  type="button"
                  ...
                  className={`p-3 rounded-2xl border flex flex-col items-center gap-1.5 focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:outline-none transition-colors ${
        ...
        <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-slate-200/60 dark:border-slate-800/60 bg-slate-50/50 dark:bg-slate-900/50">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 rounded-xl text-xs font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:outline-none transition-colors"
          >
            取消
          </button>
          <button
            ...
            onClick={handleSave}
            disabled={isLoading}
            className="px-5 py-2 rounded-xl text-xs font-semibold text-white bg-violet-600 hover:bg-violet-500 shadow-md shadow-violet-600/30 flex items-center gap-1.5 focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 focus-visible:outline-none transition-colors"
          >
